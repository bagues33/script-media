...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"  class="active"><span>More</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="domain.php">Domains</a></li>
              <li><a href="#" class="active">IIX (location Singapore)</a></li>
    ...
    <section id="price" class="inner-page price">
      <div class="container">
        ...
        <div class="row mt-5" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 m-0 p-0">
            <ul id="price-flters">
              ...
              <li data-filter=".filter-usa" id="usa">USA</li>
              <li data-filter=".filter-iix">IIX</li>
            </ul>
          </div>
        </div>
        ...
        <div class="row price-container">
          ...
          <!-- <div class="col-lg-4 col-md-6 price-item filter-app"> -->
          ...
          <!-- <div class="col-lg-4 col-md-6 price-item filter-web"> -->
          ...
          <!-- <div class="col-lg-4 col-md-6 price-item filter-card"> -->
          <div class="col-lg-3 col-md-6 mt-4 mt-lg-0 price-item filter-usa" data-aos="fade-up" data-aos-delay="300">
            <div class="box">
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-lg-0 price-item filter-iix" data-aos-delay="300">
            <div class="box">
              <span class="advanced">Advanced</span>
              <h3>Ultimate</h3>
              <h4><sup>$</sup>49<span> / month</span></h4>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
               Jl. Permadi No.II/1767, Wirogunan, Kec. Mergangsan, Kota Yogyakarta, Daerah Istimewa Yogyakarta 55151 <br><br>
    ...
    <div class="container py-4 text-center">
      <div class="copyright">
        &copy; Copyright <strong><span>SCRIPTMEDIA</span></strong>. All Rights Reserved
      </div>
    </div>
  </footer><!-- End Footer -->
  ...
  <a href="#" class="back-to-top d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      setTimeout(function(){ document.getElementById("usa").click(); }, 1000);
