...
class IIX {
	...
	protected function setup_hooks() {
		 ...
		 * Actions.
		 */
		add_shortcode('promoIIX', [ $this, 'promo_section_IIX'] );
		add_shortcode('priceIIX', [ $this, 'price_section_IIX'] );
		add_shortcode('faqIIX', [ $this, 'faq_section_IIX'] );
	}
	 ...
	 * @return array
	 */
	public function promo_section_IIX($atts, $content = null) {
	...
	public function price_section_IIX($atts, $content = null) {
			extract( shortcode_atts( array(
		'url' => '#'
		), $atts ) );
	...
	public function faq_section_IIX($atts, $content = null) {
			extract( shortcode_atts( array(
		'url' => '#'
		), $atts ) );
