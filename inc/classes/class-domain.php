...
class Domain {
	...
	protected function setup_hooks() {
		 ...
		 * Actions.
		 */
		add_shortcode('promoDomain', [ $this, 'promo_section_domain'] );
		add_shortcode('formDomain', [ $this, 'form_section_domain'] );
		add_shortcode('hargaDomain', [ $this, 'harga_section_domain'] );
		add_shortcode('faqDomain', [ $this, 'faq_section_domain'] );
	}
	 ...
	 * @return array
	 */
	public function promo_section_domain($atts, $content = null) {
	...
	public function form_section_domain($atts, $content = null) {
			extract( shortcode_atts( array(
		'url' => '#'
		), $atts ) );

		
		$html = '<section class="inner-page section-bg">
			      <div class="container">
			        <!-- ======= Domain Section ======= -->
			        <h1 class="text-center">Harga Domain</h1>
			        <section id="domain" class="domain section-bg p-0">
			          <div class="container mt-4">
			          <div class="row d-flex justify-content-center">
			              <div class="col-md-12">
			                  <div class="card p-md-4">
			                      <h4 class="heading text-center">Or Choose a Domain</h4>
			                      ...
			                      <div class="col-md-12 mt-5 px-md-5 px-3">
			                        <div class="input-group">
			                          <input type="search" class="form-control"> 
			                          <span class="input-group-addon d-none d-sm-block"><input type="submit" value="Search" class="btn btn-primary"></span>
			                        </div>
			                        <div class="search-mobile text-center mt-4 d-sm-none">
			                          <span class="input-group-addon"><input type="submit" value="Search" class="btn btn-primary"></span>
			                        </div>
			                      </div>
			                      <div class="row mt-4 g-1 px-md-5 mb-5 justify-content-center">
			                          <div class="col-md-2  col-5 col-sm-4 my-sm-3 mx-md-3 mx-md-2 mx-1 my-3">
	...
	public function harga_section_domain($atts, $content = null) {
			extract( shortcode_atts( array(
		'url' => '#'
		), $atts ) );

		
		$html = '<div class="container-fluid p-5 pt-0 section-bg"> 
		        <div class="price-domain mx-md-5 px-md-5 mx-2 justify-content-center">
	...
	public function faq_section_domain($atts, $content = null) {
			extract( shortcode_atts( array(
		'url' => '#'
		), $atts ) );
