...
class Cloud_Dedicated_Servers {
	...
	protected function setup_hooks() {
		 ...
		 * Actions.
		 */
		add_shortcode('promoCDS', [ $this, 'promo_section_CDS'] );
		add_shortcode('priceCDS', [ $this, 'price_section_CDS'] );
		add_shortcode('faqCDS', [ $this, 'faqs_section_CDS'] );
	}

	
	public function promo_section_CDS($atts, $content = null) {
		...
		public function price_section_CDS($atts, $content = null) {
			extract( shortcode_atts( array(
		'url' => '#'
		), $atts ) );
	...
	public function faq_section_CDS($atts, $content = null) {
			extract( shortcode_atts( array(
		'url' => '#'
		), $atts ) );
