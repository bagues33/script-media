	...
	public function register_block_patterns() {
		if ( function_exists( 'register_block_pattern' ) ) {
			...
			register_block_pattern(
				'sm/cover',
				[
					'title' => __( 'Sm Cover', 'sm' ),
					'description' => __( 'Sm Cover Block with image and text', 'sm' ),
					'categories' => [ 'cover' ],
			...
			register_block_pattern(
				'Sm/two-columns',
				[
					'title' => __( 'Sm Two Column', 'Sm' ),
					'description' => __( 'Sm two columns with heading and text', 'sm' ),
					'categories' => [ 'columns' ],
