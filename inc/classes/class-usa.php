...
class USA {
	...
	protected function setup_hooks() {
		 ...
		 * Actions.
		 */
		add_shortcode('promoUSA', [ $this, 'promo_section_USA'] );
		add_shortcode('priceUSA', [ $this, 'price_section_USA'] );
		add_shortcode('faqUSA', [ $this, 'faq_section_USA'] );
	}
	 ...
	 * @return array
	 */
	public function promo_section_USA($atts, $content = null) {
	...
	public function price_section_USA($atts, $content = null) {
			extract( shortcode_atts( array(
		'url' => '#'
		), $atts ) );
	...
	public function faq_section_USA($atts, $content = null) {
			extract( shortcode_atts( array(
		'url' => '#'
		), $atts ) );
