...
class VPS {
	...
	protected function setup_hooks() {
		 ...
		 * Actions.
		 */
		add_shortcode('promoVPS', [ $this, 'promo_section_vps'] );
		add_shortcode('priceVPS', [ $this, 'price_section_vps'] );
		add_shortcode('faqVPS', [ $this, 'faq_section_vps'] );
	}
	 ...
	 * @return array
	 */
	public function promo_section_vps($atts, $content = null) {
	...
	public function price_section_vps($atts, $content = null) {
			extract( shortcode_atts( array(
		'url' => '#'
		), $atts ) );
	...
	public function faq_section_vps($atts, $content = null) {
			extract( shortcode_atts( array(
		'url' => '#'
		), $atts ) );
