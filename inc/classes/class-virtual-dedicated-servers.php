...
class Virtual_Dedicated_Servers {
	use Singleton;
	...
	protected function setup_hooks() {
		 ...
		 * Actions.
		 */
		add_shortcode('promoVDS', [ $this, 'promo_section_VDS'] );
		add_shortcode('priceVDS', [ $this, 'price_section_VDS'] );
		add_shortcode('faqVDS', [ $this, 'faq_section_VDS'] );
	}

	
	public function promo_section_VDS($atts, $content = null) {
		...
		public function price_section_VDS($atts, $content = null) {
			extract( shortcode_atts( array(
		'url' => '#'
		), $atts ) );
			      ...
			      <div class="container">
			        <div class="row">
			          <div class="col-8 mx-auto">
			              <h1 class="text-center">Cloud Dedicated Servers</h1>
			        ...
			        <div class="row mt-5" data-aos="fade-up" data-aos-delay="100">
			          <div class="col-lg-12 m-0 p-0">
			            <ul id="price-flters">
			              ...
			              <li data-filter=".filter-usa" id="click">USA</li>
	...
	public function faq_section_VDS($atts, $content = null) {
			extract( shortcode_atts( array(
		'url' => '#'
		), $atts ) );
