...
?>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" class="d-flex align-items-start" style="background: url('<?php echo get_template_directory_uri() . '/assets/img/hero-bg.jpg';?>') top left;">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="price-flters">
              ...
              <li data-filter=".filter-sh" id="sh">Shared Hosting</li>
